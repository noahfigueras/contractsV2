import { ForkBlobs, ForkPreBlobs, ForkExecution } from "@lodestar/params";
import { allForks, altair, BLSPubkey, BLSSignature, CommitteeIndex, Epoch, phase0, bellatrix, Root, Slot, UintNum64, UintBn64, ValidatorIndex, RootHex, SubcommitteeIndex, Wei, ProducedBlockSource } from "@lodestar/types";
import { ApiClientResponse } from "../../interfaces.js";
import { HttpStatusCode } from "../../utils/client/httpStatusCode.js";
import { RoutesData, ReturnTypes, ReqSerializers } from "../../utils/index.js";
import { U64Str } from "../../utils/serdes.js";
...
export type ProduceBlockOrContentsRes = {
    ...
    data: allForks.BlockContents;
    version: ForkBlobs;
});
export type ProduceBlindedBlockRes = {
    executionPayloadValue: Wei;
    consensusBlockValue: Wei;
} & {
...
export type Api = {
     ...
     * @throws ApiError
     */
    getAttesterDuties(epoch: Epoch, validatorIndices: ValidatorIndex[]): Promise<ApiClientResponse<{
        [HttpStatusCode.OK]: {
            data: AttesterDuty[];
     ...
     * @throws ApiError
     */
    getProposerDuties(epoch: Epoch): Promise<ApiClientResponse<{
        [HttpStatusCode.OK]: {
            data: ProposerDuty[];
            executionOptimistic: ExecutionOptimistic;
            dependentRoot: RootHex;
    ...
    getSyncCommitteeDuties(epoch: number, validatorIndices: ValidatorIndex[]): Promise<ApiClientResponse<{
        [HttpStatusCode.OK]: {
            data: SyncDuty[];
            executionOptimistic: ExecutionOptimistic;
        };
     ...
     * @throws ApiError
     */
    produceBlock(slot: Slot, randaoReveal: BLSSignature, graffiti: string): Promise<ApiClientResponse<{
        [HttpStatusCode.OK]: {
            data: allForks.BeaconBlock;
        };
    }, HttpStatusCode.BAD_REQUEST | HttpStatusCode.SERVICE_UNAVAILABLE>>;
     ...
     * @throws ApiError
     */
    produceBlockV2(slot: Slot, randaoReveal: BLSSignature, graffiti: string): Promise<ApiClientResponse<{
     ...
     * @throws ApiError
     */
    produceBlockV3(slot: Slot, randaoReveal: BLSSignature, graffiti: string, skipRandaoVerification?: boolean, opts?: ExtraProduceBlockOps): Promise<ApiClientResponse<{
        [HttpStatusCode.OK]: ProduceFullOrBlindedBlockOrContentsRes;
    }, HttpStatusCode.BAD_REQUEST | HttpStatusCode.SERVICE_UNAVAILABLE>>;
    produceBlindedBlock(slot: Slot, randaoReveal: BLSSignature, graffiti: string): Promise<ApiClientResponse<{
     ...
     * @throws ApiError
     */
    produceAttestationData(index: CommitteeIndex, slot: Slot): Promise<ApiClientResponse<{
        [HttpStatusCode.OK]: {
            data: phase0.AttestationData;
        };
    }, HttpStatusCode.BAD_REQUEST | HttpStatusCode.SERVICE_UNAVAILABLE>>;
    produceSyncCommitteeContribution(slot: Slot, subcommitteeIndex: number, beaconBlockRoot: Root): Promise<ApiClientResponse<{
        [HttpStatusCode.OK]: {
     ...
     * @throws ApiError
     */
    getAggregatedAttestation(attestationDataRoot: Root, slot: Slot): Promise<ApiClientResponse<{
        [HttpStatusCode.OK]: {
     ...
     * @throws ApiError
     */
    publishAggregateAndProofs(signedAggregateAndProofs: phase0.SignedAggregateAndProof[]): Promise<ApiClientResponse<{
        [HttpStatusCode.OK]: void;
    }, HttpStatusCode.BAD_REQUEST>>;
    publishContributionAndProofs(contributionAndProofs: altair.SignedContributionAndProof[]): Promise<ApiClientResponse<{
        [HttpStatusCode.OK]: void;
    }, HttpStatusCode.BAD_REQUEST>>;
    /**
     ...
     * @throws ApiError
     */
    prepareBeaconCommitteeSubnet(subscriptions: BeaconCommitteeSubscription[]): Promise<ApiClientResponse<{
        [HttpStatusCode.OK]: void;
    }, HttpStatusCode.BAD_REQUEST | HttpStatusCode.SERVICE_UNAVAILABLE>>;
    prepareSyncCommitteeSubnets(subscriptions: SyncCommitteeSubscription[]): Promise<ApiClientResponse<{
        [HttpStatusCode.OK]: void;
    }, HttpStatusCode.BAD_REQUEST | HttpStatusCode.SERVICE_UNAVAILABLE>>;
    prepareBeaconProposer(proposers: ProposerPreparationData[]): Promise<ApiClientResponse<{
        [HttpStatusCode.OK]: void;
    }, HttpStatusCode.BAD_REQUEST>>;
    /**
     ...
     * @throws ApiError
     */
    submitBeaconCommitteeSelections(selections: BeaconCommitteeSelection[]): Promise<ApiClientResponse<{
        [HttpStatusCode.OK]: {
            data: BeaconCommitteeSelection[];
        };
     ...
     * @throws ApiError
     */
    submitSyncCommitteeSelections(selections: SyncCommitteeSelection[]): Promise<ApiClientResponse<{
        [HttpStatusCode.OK]: {
            data: SyncCommitteeSelection[];
        };
    }, HttpStatusCode.BAD_REQUEST | HttpStatusCode.NOT_IMPLEMENTED | HttpStatusCode.SERVICE_UNAVAILABLE>>;
    /** Returns validator indices that have been observed to be active on the network */
    getLiveness(epoch: Epoch, validatorIndices: ValidatorIndex[]): Promise<ApiClientResponse<{
        [HttpStatusCode.OK]: {
