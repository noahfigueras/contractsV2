...
function responseFormatFromMediaType(mediaType) {
    switch (mediaType) {
        default:
        case MediaType.json:
            return "json";
...
export function writeAcceptHeader(format) {
...
export function parseAcceptHeader(accept) {
    ...
    return responseFormatFromMediaType(accept
        .toLowerCase()
        .split(",")
        .map((x) => x.trim())
        .reduce((best, current) => {
...
//# sourceMappingURL=acceptHeader.js.map