...
export type Api = {
     ...
     */
    listKeys(): Promise<ApiClientResponse<{
        [HttpStatusCode.OK]: {
            data: {
     ...
     * https://github.com/ethereum/keymanager-APIs/blob/0c975dae2ac6053c8245ebdb6a9f27c2f114f407/keymanager-oapi.yaml
     */
    importKeystores(keystoresStr: KeystoreStr[], passwords: string[], slashingProtectionStr?: SlashingProtectionData): Promise<ApiClientResponse<{
        [HttpStatusCode.OK]: {
     ...
     * https://github.com/ethereum/keymanager-APIs/blob/0c975dae2ac6053c8245ebdb6a9f27c2f114f407/keymanager-oapi.yaml
     */
    deleteKeys(pubkeysHex: string[]): Promise<ApiClientResponse<{
        [HttpStatusCode.OK]: {
     ...
     */
    listRemoteKeys(): Promise<ApiClientResponse<{
        [HttpStatusCode.OK]: {
     ...
     */
    importRemoteKeys(remoteSigners: Pick<SignerDefinition, "pubkey" | "url">[]): Promise<ApiClientResponse<{
        [HttpStatusCode.OK]: {
            data: ResponseStatus<ImportRemoteKeyStatus>[];
        };
    }>>;
    deleteRemoteKeys(pubkeys: PubkeyHex[]): Promise<ApiClientResponse<{
        [HttpStatusCode.OK]: {
            data: ResponseStatus<DeleteRemoteKeyStatus>[];
        };
    }>>;
    listFeeRecipient(pubkey: string): Promise<ApiClientResponse<{
        [HttpStatusCode.OK]: {
            data: FeeRecipientData;
        };
    }>>;
    setFeeRecipient(pubkey: string, ethaddress: string): Promise<ApiClientResponse<{
        [HttpStatusCode.OK]: void;
        [HttpStatusCode.NO_CONTENT]: void;
    }, HttpStatusCode.UNAUTHORIZED | HttpStatusCode.FORBIDDEN | HttpStatusCode.NOT_FOUND>>;
    deleteFeeRecipient(pubkey: string): Promise<ApiClientResponse<{
        [HttpStatusCode.OK]: void;
        [HttpStatusCode.NO_CONTENT]: void;
    }, HttpStatusCode.UNAUTHORIZED | HttpStatusCode.FORBIDDEN | HttpStatusCode.NOT_FOUND>>;
    listGraffiti(pubkey: string): Promise<ApiClientResponse<{
        [HttpStatusCode.OK]: {
            data: GraffitiData;
        };
    }>>;
    setGraffiti(pubkey: string, graffiti: string): Promise<ApiClientResponse<{
        [HttpStatusCode.OK]: void;
        [HttpStatusCode.NO_CONTENT]: void;
    }, HttpStatusCode.UNAUTHORIZED | HttpStatusCode.FORBIDDEN | HttpStatusCode.NOT_FOUND>>;
    deleteGraffiti(pubkey: string): Promise<ApiClientResponse<{
        [HttpStatusCode.OK]: void;
        [HttpStatusCode.NO_CONTENT]: void;
    }, HttpStatusCode.UNAUTHORIZED | HttpStatusCode.FORBIDDEN | HttpStatusCode.NOT_FOUND>>;
    getGasLimit(pubkey: string): Promise<ApiClientResponse<{
        [HttpStatusCode.OK]: {
            data: GasLimitData;
        };
    }>>;
    setGasLimit(pubkey: string, gasLimit: number): Promise<ApiClientResponse<{
        [HttpStatusCode.OK]: void;
        [HttpStatusCode.NO_CONTENT]: void;
    }, HttpStatusCode.UNAUTHORIZED | HttpStatusCode.FORBIDDEN | HttpStatusCode.NOT_FOUND>>;
    deleteGasLimit(pubkey: string): Promise<ApiClientResponse<{
        [HttpStatusCode.OK]: void;
        [HttpStatusCode.NO_CONTENT]: void;
    }, HttpStatusCode.UNAUTHORIZED | HttpStatusCode.FORBIDDEN | HttpStatusCode.NOT_FOUND>>;
    getBuilderBoostFactor(pubkey: string): Promise<ApiClientResponse<{
        [HttpStatusCode.OK]: {
            data: BuilderBoostFactorData;
        };
    }>>;
    setBuilderBoostFactor(pubkey: string, builderBoostFactor: bigint): Promise<ApiClientResponse<{
        [HttpStatusCode.OK]: void;
        [HttpStatusCode.NO_CONTENT]: void;
    }, HttpStatusCode.UNAUTHORIZED | HttpStatusCode.FORBIDDEN | HttpStatusCode.NOT_FOUND>>;
    deleteBuilderBoostFactor(pubkey: string): Promise<ApiClientResponse<{
        [HttpStatusCode.OK]: void;
        [HttpStatusCode.NO_CONTENT]: void;
    }, HttpStatusCode.UNAUTHORIZED | HttpStatusCode.FORBIDDEN | HttpStatusCode.NOT_FOUND>>;
    /**
     ...
     */
    signVoluntaryExit(pubkey: PubkeyHex, epoch?: Epoch): Promise<ApiClientResponse<{
        [HttpStatusCode.OK]: {
